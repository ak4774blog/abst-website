// PerkCard component remains the same.
function PerkCard({ title, description, icon }) {
  return (
...
// Main component updated to match the style of CompetitionInfo.jsx
export default function JoinUs() {
  return (
    // 1. Container matches the guide: `max-w-4xl` and `py-12`
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      {/* 2. Main heading matches the guide: `mb-12` */}
      ...
      {/* 3. A new wrapper div uses `space-y-12` to match the spacing between sections in the guide */}
      <div className="space-y-8">
        ...
        <section>
          <div className="text-center bg-slate-800 p-10 rounded-lg border border-slate-700">
            ...
            {/* 4. Paragraph font size and color now match the guide's body text */}
            <p className="mt-2 mb-6 text-lg text-slate-300">
              Click the link below to fill out our volunteer sign-up form. We can't wait to have you on the team!
            </p>
            <a
        ...
        {/* Perks Section */}
        <section>
          {/* 5. Section heading now matches the guide's `InfoSection` style */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <PerkCard
              ...
              description="You will be able to inspire the younger generation through the problems which will intruduce them to interesting parts of science."
